...
ALTER TABLE Office
ADD CONSTRAINT fk_office FOREIGN KEY (Facility_ID) REFERENCES Facility(Facility_ID) ON DELETE CASCADE;
...
ALTER TABLE Outpatient_Surgery
ADD CONSTRAINT fk_ops FOREIGN KEY (Facility_ID) REFERENCES Facility(Facility_ID) ON DELETE CASCADE;
...
ADD CONSTRAINT fk_emp FOREIGN KEY (Facility_ID) REFERENCES Facility(Facility_ID) ON DELETE RESTRICT;
...
ALTER TABLE Other_HCP
ADD CONSTRAINT fk_hcp FOREIGN KEY (Employee_ID) REFERENCES Employee(Employee_ID) ON DELETE CASCADE;
...
ALTER TABLE Doctor
ADD CONSTRAINT fk_doctor FOREIGN KEY (Employee_ID) REFERENCES Employee(Employee_ID) ON DELETE CASCADE;
...
ALTER TABLE Nurse
ADD CONSTRAINT fk_nurse FOREIGN KEY (Employee_ID) REFERENCES Employee(Employee_ID) ON DELETE CASCADE;
...
ALTER TABLE Admin
ADD CONSTRAINT fk_admin FOREIGN KEY (Employee_ID) REFERENCES Employee(Employee_ID) ON DELETE CASCADE;
...
ALTER TABLE Patient
ADD CONSTRAINT fk_patient FOREIGN KEY (Primary_Physician_ID) REFERENCES Doctor(Employee_ID) ON DELETE SET NULL;
...
ALTER TABLE Invoice
ADD CONSTRAINT fk_invoice FOREIGN KEY (Insurer_ID) REFERENCES Insurance_Company(Insurer_ID) ON DELETE CASCADE;
...
ALTER TABLE Insured_By
ADD CONSTRAINT fk_insured_by1 FOREIGN KEY (Patient_ID) REFERENCES Patient(Patient_ID) ON DELETE CASCADE;

ALTER TABLE Insured_By
ADD CONSTRAINT fk_insured_by2 FOREIGN KEY (Insurer_ID) REFERENCES Insurance_Company(Insurer_ID) ON DELETE CASCADE;
