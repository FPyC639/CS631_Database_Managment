<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($_POST["operation"] == $u){
            ...
            elseif ($empjobclass == "MD") {
                $docspecialty = $_POST["empspec"];
                $docbdcertdate1 = $_POST["empbdcertdt"];
                $docbdcertdate = date('Y-m-d', strtotime($docbdcertdate1));
        ...
        if ($_POST["operation"] == $d) {
            ...
            $sql_delete_superclass = "DELETE FROM Employee WHERE Employee_ID = ?";
