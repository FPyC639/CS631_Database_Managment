    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($_POST["operation"] == $u){
            ...
            if ($inscompstreet !== null || $inscompcity !== null || $inscompstate !== null || $inscompzip !== null || $inscompname !== null) {
                $sql .= " WHERE Insurer_ID = :ins_id_val";
                $stmt_update_main = $pdo->prepare($sql);
                $stmt_update_main->bindParam(':ins_id_val', $insurer_id, PDO::PARAM_INT);
        ...
        if ($_POST["operation"] == $d) {
            ...
            $sql_delete_main = "DELETE FROM Facility WHERE Insurer_ID = :ins_id_val";
            $stmt_del_main_rec = $pdo->prepare($sql_delete_main);
            $stmt_del_main_rec->bindParam('fac_id_val', $insurer_id, PDO::PARAM_INT);
