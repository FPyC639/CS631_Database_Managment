<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT E.Employee_ID as Employee_ID, E.Facility_ID as Facility_ID FROM Employee E";
...
<html>
<head>
    <title>View Employee Assignments Data</title>
</head>
<body>
    <h2>Employee Assignments Data</h2>
