...
<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT Facility_ID, Date_Time, Physician_ID, Patient_ID, Description, Invoice_ID, Cost
            FROM Invoice_Detail
            WHERE Facility_ID = $selected_fac_id AND (CAST(Date_Time AS DATE) >= '$selected_begin_date' AND CAST(Date_Time AS DATE) <= '$selected_end_date')";
